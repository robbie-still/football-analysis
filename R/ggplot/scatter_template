...
data <- readxl::read_excel("playmakers.xlsx") %>% 
...
p2 <- ggplot(data, aes(x= PassCompletion, y= xAper90, label=player, col = colour))+
  geom_text_repel(
...
#ggsave(p2, filename = "playmakers-new.jpeg", device = "jpeg")
